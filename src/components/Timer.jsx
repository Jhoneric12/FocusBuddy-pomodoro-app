    ...
    <div className='select-none'>
      <div className='flex items-center flex-col'>
        <div className='flex gap-4 text-[0.875rem]'>
            <button className='text-font-color focus:bg-secondary-color rounded-md p-2' onClick={() => toggle(1)}>Pomodoro</button>
            <button className='text-font-color focus:bg-secondary-color rounded-md p-2' onClick={() => toggle(2)}>Short Break</button>
            <button className='text-font-color focus:bg-secondary-color rounded-md p-2' onClick={() => toggle(3)}>Long Break</button>
        </div>
        {timerContent}
        {
            isRunning
